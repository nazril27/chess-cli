...
async function startGame() {
    ...
    while(true) {
        ...
        if (isCastling) {
            ...
            // 2. Tidak boleh melewati kotak yang sedang diserang musuh
            // Kita hitung kotak tengah yang dilewati Raja
            const midCol = (moveData.fromCol + moveData.toCol) / 2;
            
            // Lakukan simulasi bayangan (Time Travel) ke kotak tengah
